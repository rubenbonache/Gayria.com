...
?>
  ...
  <div data-role="header" data-position="inline">
    <?php echo anchor('/', 'Home', 'data-transition="slide" data-icon="home" data-direction="reverse" data-iconpos="notext"')?>
    <h1>Gayria.com</h1>
  </div>
  ...
  <tr>
    ...
    <td><input class="field" name="name" type="text" id="name" value="<?php echo $name;?>"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
    	<fieldset data-type="horizontal" data-mini="true" data-role="controlgroup">
