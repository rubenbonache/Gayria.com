...
<table class="table" width="730" border="0">
  ...
  <tr>
    ...
    <td colspan="3" width="550"><textarea class="field" rows="10" cols="60" name="frasedia" cols="50" rows="5"  id="frasedia"><?php echo $frasedia;?></textarea></td>
  </tr>
  </table>
</fieldset>
<fieldset class="fieldset"><legend><h2><?php echo $this->lang->line('fisico')?></h2></legend>
  ...
  <tr>
    ...
    <td colspan="2" width="550">
      <select class="field" style="width:200px" name="look" id="Look">
...
<fieldset class="fieldset"><legend><h2><?php echo $this->lang->line('msituacion')?></h2></legend>
<table class="table" width="730" border="0">
  <tr>
...
<fieldset class="fieldset"><legend><h2><?php echo $this->lang->line('mgustos')?></h2></legend>
<table class="table" width="730" border="0">
  <tr>
...
<fieldset class="fieldset"><legend><h2><?php echo $this->lang->line('msexual')?></h2></legend>
<table class="table" width="730" border="0">
  <tr>
