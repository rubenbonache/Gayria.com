      ...
      <select class="field4" style="width:200px" name="estado" id="estado">
        ...
        ?>
			  ...
			  <?php		
	  				...
	  				$usuario = array('id'=>'','user'=>'none','pass'=>md5($this->input->post('password1')),'fecha'=>time(),'status'=>'4','fotoperfil'=>0,'name'=>$this->input->post('nombre'),'apellido'=>$this->input->post('apellidos'),'fnacimiento'=>json_encode($this->input->post('fnacimiento')),'email'=>$this->input->post('email'),'soy'=>0,'orientacion'=>0,'pais'=>$this->input->post('pais'),'estado'=>$this->input->post('estado'),'idiomas'=>'','frasedia'=>'','look'=>0,'raza'=>0,'estatura'=>0,'peso'=>0,'complexion'=>0,'ojos'=>0,'pelo'=>0,'vello'=>0,'largopolla'=>0,'grosopolla'=>0,'circunci'=>0,'piercing'=>0,'tatus'=>0,'armario'=>0,'situacion'=>0,'actitud'=>0,'busco'=>0,'quebusco'=>'','tabaco'=>0,'alcohol'=>0,'drogas'=>0,'aficiones'=>'','fidelidad'=>0,'rol'=>0,'sexosegur'=>0,'tipochico'=>'','fetiches'=>'','psexuales'=>'');
