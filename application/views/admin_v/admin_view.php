...
<html lang="fr">
    <head>
        ...
        <script  type="text/javascript" src="./assets/js/fileupload/bootstrap.min.js" ></script>
                ...
                <div id="content-admin">
                    ...
                    <div id="new-article">
                        ...
                        <div id="upload-img">
                            ...
                            <form id="fileupload" action="<? echo base_url() . 'admin/upload_img'; ?>" method="POST" enctype="multipart/form-data">
