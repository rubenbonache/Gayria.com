...
(function($)
{
    ...
    function fileTemplate(list, fileobj, settings)
    {
    	...
    	var prevC	= $('<a class="ax-prev-container" style="display:none" />').appendTo(li);
    	var prevImg	= $('<img class="ax-preview" src="" alt="Preview" />').appendTo(prevC);
    	var details	= $('<div class="ax-details" />').appendTo(li);
    	
	    var nameC	= $('<div class="ax-file-name" style="display:none" >'+fn+'</div>').appendTo(details);
	    ...
	    var sizeC	= $('<div class="ax-file-size" style="display:none">'+size+'</div>').appendTo(details);
    	var progres	= $('<div class="ax-progress" />').appendTo(li);
	    var pBar	= $('<div class="ax-progress-bar" />').appendTo(progres);
	    var pNum	= $('<div class="ax-progress-info"></div>');
    ...
    function ajaxList(list, obj, settings)
    {
    	...
    	obj.end = function(name, size, status, info)
	    {
	    	...
	    	{
	    		//window.location = 'http://macbook.local/~ruben/Gayria.com/index.php/perfil/me/galeria';
	    ...
	    obj.remove = function()
	    {
	    	document.getElementById('ax-browse').style.display="";
    ...
    {
    	document.getElementById('ax-browse').style.display="none";
    	var FILES = settings.FILES;
	...
	var methods =
	{
		init : function(options)
		{
    	    ...
    	    {	
				...
				var fieldSet  	= $('<div style="align: right; height: 28px;"/>').appendTo($this);
				var browse_c  	= $('<a class="ax-browse-c ax-button" id="ax-browse" title="Add Files" />').appendTo(fieldSet);//Browse container
